...
- Robot Wrong initial pose: [Robot Wrong 2D pose estimate in RViz](screenshots/task6_wrong_initial_2d_pose_estimate_1.png)
- [Robot Wrong initial pose LiDAR misalignmenet in RViz](screenshots/task6_wrong_initial_2d_pose_estimate.png)
